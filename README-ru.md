...
Программа написана с использованием Rust и TypeScript, а графический интерфейс реализован с помощью Tauri. Под капотом этот графический интерфейс использует [rvpacker-json-txt](https://github.com/savannstm/rvpacker-json-txt) для парсинга и записи .json файлов RPG Maker MV/MZ и [TypeScript имплементацию маршала Ruby](https://github.com/savannstm/marshal) для парсинга и записи файлов RPG Maker XP/VX/VXAce.
